...
class WeightWizard(QtWidgets.QMainWindow):
    ...
    def __init__(self, rigUiInst,  parent = None):
        ...
        self.page5VerticalLayout.addSpacerItem(QtWidgets.QSpacerItem(0, 200, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed))
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    def smoothBindSelected(self):
        ...
        skinCluster = cmds.skinCluster(tsb = True, maximumInfluences = maxInf, obeyMaxInfluences = maintainMax, dropoffRate = dropoff, bindMethod = 0, skinMethod = 0, normalizeWeights = 1, name = geo + "_skinCluster")[0]
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    def toggleButtonState(self, button):
        ...
        buttonImageOn =  os.path.normcase(os.path.join(self.iconsPath, "System/blue_field_background.png"))
        if buttonImageOn.partition("\\")[2] != "":
            buttonImageOn = buttonImageOn.replace("\\", "/")

        buttonImageOff =  os.path.normcase(os.path.join(self.iconsPath, "System/field_background.png"))
